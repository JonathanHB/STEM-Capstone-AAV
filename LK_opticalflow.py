...
class Hoop_finder:
	...
	def __init__(self):
		...
		self.old_xdeltas1 = np.zeros((2,100), dtype = "float32")
		self.old_xdeltas2 = np.zeros((2,100), dtype = "float32")
	...
	def getdeltas(self, angles1, angles2):

		d_angles = [[0.0]*len(self.p0), [0.0]*len(self.p0)]
